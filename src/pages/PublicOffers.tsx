...
export const PublicOffers = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-amber-50 flex items-center justify-center" dir="rtl">
        <div className="text-center">
          <div className="animate-spin rounded-full h-32 w-32 border-b-2 border-blue-600 mx-auto"></div>
          <p className="mt-4 text-lg text-gray-600 text-right">جارٍ تحميل العروض...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-amber-50" dir="rtl">
      {/* Header */}
      <div className="bg-white shadow-md" dir="rtl">
          ...
          <div className="flex justify-between items-center" dir="rtl">
            <div className="flex items-center gap-4" dir="rtl">
              ...
              <div className="text-right">
                <h1 className="text-2xl font-bold text-blue-600 text-right">شركة أوقات للسياحة والسفر</h1>
                <p className="text-sm text-gray-600 text-right">حولي - شارع تونس - بناية هيا</p>
              </div>
            </div>
            <Button 
            ...
            >
              ...
              <span className="text-right">تسجيل الدخول</span>
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8" dir="rtl">
        <div className="text-center mb-8" dir="rtl">
          <h2 className="text-4xl font-bold text-gray-800 mb-4 text-right">العروض السياحية المتاحة</h2>
          <p className="text-lg text-gray-600 text-right">اكتشف أفضل الوجهات السياحية بأسعار مميزة</p>
        </div>

        {offers.length === 0 ? (
          <div className="text-center py-12" dir="rtl">
            <p className="text-xl text-gray-500 text-right">لا توجد عروض متاحة حالياً</p>
          </div>
        ) : (
      ...
      <footer className="bg-gray-800 text-white py-8 mt-12" dir="rtl">
        <div className="container mx-auto px-4 text-center" dir="rtl">
          <div className="flex justify-center items-center gap-4 mb-4" dir="rtl">
            <img 
              src="/lovable-uploads/a301b0cc-0db5-40a4-9c35-c8003adb6c82.png" 
              alt="شعار الشركة" 
            ...
            />
            <div className="text-right">
              <h3 className="text-xl font-bold text-right">شركة أوقات للسياحة والسفر</h3>
              <p className="text-gray-300 text-right">حولي - شارع تونس - بناية هيا</p>
            </div>
          </div>
          <div className="space-y-2 text-gray-300 text-right">
            <p className="text-right">هاتف: +965 2222 7779</p>
            <p className="text-right">واتساب: +965 2222 7779</p>
            <p className="text-right">© 2024 شركة أوقات للسياحة والسفر. جميع الحقوق محفوظة.</p>
          </div>
        </div>
      </footer>
    </div>
