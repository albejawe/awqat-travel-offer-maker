                          ...
                          <div className="space-y-6 text-right">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="space-y-3">
                                <h3 className="font-semibold text-lg text-gray-800">تفاصيل الرحلة</h3>
                              ...
                              <div className="space-y-3">
                                <h3 className="font-semibold text-lg text-gray-800">خدمات الرحلة</h3>
                            ...
                            {selectedOffer.pricing_tiers && selectedOffer.pricing_tiers.length > 0 && (
                              <div>
                                <h3 className="font-semibold text-lg text-gray-800 mb-2">الأسعار</h3>
